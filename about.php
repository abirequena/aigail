			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li class="active"><a class="nav-link" href="about.php">Sobre Nosotros</a></li>
					</ul>
				</div>
			</div>
				...
				<div class="row justify-content-between">
					<div class="col-lg-5">
						<div class="intro-excerpt">
							<h1>SOBRE <br> <span clsas="d-block"> <i> NOSOTROS </i></span></h1>
							<p class="mb-4">Nuestra misión es proporcionar soluciones de belleza y cuidado personal de alta calidad, promoviendo la autoestima y la confianza en nuestros clientes a través de productos seguros y efectivos.</p>
							<p><a href="shop.php" class="btn btn-secondary me-2">Ver Catalogo</a><a href="about.php" class="btn btn-white-outline">Sobre Nosotros</a></p>
						</div>
					</div>
					<div class="col-lg-7">
	...
	<div class="container">
		<div class="row justify-content-between">
			<div class="col-lg-6">
				...
				<p> "Abi Cosmetics" es una gama integral de productos y servicios de cuidado personal diseñados para abordar las necesidades de bienestar y confianza personal de las personas. Esto incluye:</p>
	...
	<div class="container">
		<div class="row justify-content-between">
			...
			<div class="col-lg-5 ps-lg-5">
				...
				<p>La sociedad actual está marcada por un ritmo de vida acelerado y altas expectativas de belleza y cuidado personal. Como resultado, muchas personas experimentan estrés, falta de tiempo y preocupaciones relacionadas con su apariencia, lo que puede afectar su bienestar emocional y autoestima.</p>
				...
				<p><a herf="#" class="btn">Explorar Catalogo</a></p>
			</div>
		</div>
	</div>
</div>
			...
			<div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
				<div class="product-item-sm d-flex">
					...
					<div class="pt-3">
						...
						<p> amplia gama de productos de cuidado facial de alta calidad formulados con ingredientes naturales y seguros. </p>
